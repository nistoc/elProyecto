...
| `GetProjectFilesCatalogAsync(artifactRoot, ct)` + gRPC `GetProjectFiles` | 2 | Полное дерево файлов job (категории как Xtract `JobProjectFilesScanner`; сканер — `ProjectFilesCatalogScanner`). |
