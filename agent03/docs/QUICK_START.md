...
> **Agent03 v3.0** использует интеллектуальную диаризацию спикеров для точной транскрипции диалогов и интервью.
...
**Решение:** agent03 автоматически обходит эту проблему используя `torchaudio`.
...
agent03 --config config/my_config.json
