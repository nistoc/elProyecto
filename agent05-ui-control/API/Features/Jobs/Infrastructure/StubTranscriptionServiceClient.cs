...
public sealed class StubTranscriptionServiceClient : Application.ITranscriptionServiceClient
{
    ...
    public Task<Application.ChunkCommandResult> ChunkCommandAsync(string agent04JobId, Application.TranscriptionChunkAction action, int chunkIndex, string? jobDirectoryRelative = null, CancellationToken ct = default) =>
