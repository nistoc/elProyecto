...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    silencePanelTitleConverting: 'Converting to WAV',
    silencePanelTitleDetecting: 'Detecting silence',
    silencePanelTitleCompressing: 'Compressing silence',
    silencePanelTitleGeneric: 'Preparing audio',
    silencePanelHint:
      'Long files may take several minutes while silence is detected, segments are cut, and the WAV is rebuilt.',
    silencePanelSegments: 'Segments: {current} / {total}',
    silencePanelStepElapsed: 'This step: {elapsed}',
  ...
  ru: {
    ...
    silencePanelTitleConverting: 'Конвертация в WAV',
    silencePanelTitleDetecting: 'Поиск тишины',
    silencePanelTitleCompressing: 'Сжатие тишины',
    silencePanelTitleGeneric: 'Подготовка аудио',
    silencePanelHint:
      'Для длинных файлов поиск тишины, нарезка сегментов и сборка WAV могут занять несколько минут.',
    silencePanelSegments: 'Сегменты: {current} / {total}',
    silencePanelStepElapsed: 'Этот шаг: {elapsed}',
    silencePanelAriaLabel: 'Очистка тишины и подготовка аудио',
  ...
  es: {
    ...
    silencePanelTitleConverting: 'Conversión a WAV',
    silencePanelTitleDetecting: 'Detección de silencios',
    silencePanelTitleCompressing: 'Compresión de silencios',
    silencePanelTitleGeneric: 'Preparación de audio',
    silencePanelHint:
      'Los archivos largos pueden tardar varios minutos: detección de silencio, cortes y reconstrucción del WAV.',
    silencePanelSegments: 'Segmentos: {current} / {total}',
    silencePanelStepElapsed: 'Este paso: {elapsed}',
    silencePanelAriaLabel: 'Limpieza de silencio y preparación de audio',
