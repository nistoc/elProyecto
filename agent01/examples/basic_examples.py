#!/usr/bin/env python3
"""
Практические примеры использования модулей agent01 для внешних агентов.
"""
import sys
import os
...
def example_full_pipeline():
    ...
    config = Config.from_file("agent01/config.json")
    
    # Показать план выполнения
    config.print_plan("agent01/config.json")
...
def example_chunking_only():
    ...
    from agent01 import AudioChunker
...
def example_transcription_only():
    ...
    from agent01 import OpenAITranscriptionClient
    import os
...
def example_cache_management():
    ...
    from agent01 import CacheManager
...
def example_output_formatting():
    ...
    from agent01 import OutputWriter, ASRSegment
...
def example_audio_utils():
    ...
    from agent01 import AudioUtils
